...
def main() -> None:
    ...
    # Font
    font_large = pygame.font.SysFont("avenir next", 40)
    font_medium = pygame.font.SysFont("avenir next", 30)
    font_small = pygame.font.SysFont("avenir next", 25)
    ...
    while not done:
        ...
        if score < winscore:
            ...
            screen.blit(font_medium.render("Jump underneath a cloud to warp through", True, BLACK), (885, 210))
            screen.blit(font_medium.render("Stay too long on a cloud and you'll fall through", True, BLACK), (850, 250))
        ...
        if score >= winscore:
            ...
            screen.blit(font_small.render(f"Time taken: {time_won} seconds", True, BLACK), (725, 330))
            screen.blit(font_small.render(f"High score: {high_scoretime} seconds", True, BLACK), (725, 360))
            screen.blit(pygame.transform.scale(pygame.image.load("./images/cake.png"), (420, 420)), (650, 380))
            screen.blit(font_small.render("Thanks for playing!", True, BLACK), (735, 800))
            screen.blit(font_small.render("Created by Candice Tsai", True, BLACK), (720, 830))
        ...
        # Score
        if score < winscore:
            screen.blit(font_medium.render(f"Score: {score}", True, BLACK), (1450, 15))
        ...
        if score < winscore:
            screen.blit(font_small.render(f"Time: {time_now}", True, BLACK), (1450, 45))
